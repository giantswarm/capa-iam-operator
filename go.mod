module github.com/giantswarm/capa-iam-operator/v3
...
replace github.com/dvsekhvalnov/jose2go v1.6.0 => github.com/dvsekhvalnov/jose2go v1.8.0
...
replace go.opentelemetry.io/otel v1.28.0 => go.opentelemetry.io/otel v1.44.0

replace golang.org/x/net v0.52.0 => golang.org/x/net v0.57.0
